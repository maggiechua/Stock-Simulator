...
public class StocksViewImplTest {
  ...
  public void testWelcome() {
    ...
    String expectedOutput = "Welcome to the stocks application! \n"
            ...
            + "check-portfolio portfolio-name (checks portfolio value at a specific date) \n"
            + "sell-stock stock-symbol number-of-shares (sell stock shares) \n"
            + "composition portfolio-name (displays composition of a portfolio) \n"
            + "distribution portfolio-name (displays distribution of a portfolio) \n"
            + "balance portfolio-name (re-balances the portfolio with given weights) \n"
            + "bar-chart portfolio-name (outputs a par chart displaying the performance of a portfolio int the given range) \n"
